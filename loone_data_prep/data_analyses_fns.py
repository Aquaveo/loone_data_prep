...
def Csv_Date_Range(
    File_Name, start_year, start_month, start_day, end_year, end_month, end_day
):
...
def DF_Date_Range(
    df_Name, start_year, start_month, start_day, end_year, end_month, end_day
):
    # Identify the date ranges
    startyear = start_year
    startmonth = start_month
...
def Replicate_oneyear(ReferenceYear, year, day_num):
    ...
    day_value = (
        ...
        else ReferenceYear["Data"].iloc[day_num_adj - 1]
    )  # noqa: E501
    return day_value
